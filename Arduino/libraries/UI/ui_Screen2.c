...
void ui_Screen2_screen_init(void)
{
    ...
    lv_image_set_src(ui_Image3, &ui_img_icon_volume_40_png);
    ...
    lv_image_set_inner_align(ui_Image3, LV_IMAGE_ALIGN_TILE);
    ...
    lv_obj_set_style_arc_image_src(ui_VolumeArc, &ui_img_bar_light_01_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_image_src(ui_VolumeArc, &ui_img_bar_bule_02_png, LV_PART_INDICATOR | LV_STATE_DEFAULT);
