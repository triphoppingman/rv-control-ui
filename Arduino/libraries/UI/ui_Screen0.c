...
void ui_Screen0_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_Screen0, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_SCROLLABLE |
    ...
    lv_image_set_src(ui_progress, &ui_img_power_on_progress_60px_png);
    ...
    lv_image_set_src(ui_Image4, &ui_img_power_on_light_400_250707_png);
